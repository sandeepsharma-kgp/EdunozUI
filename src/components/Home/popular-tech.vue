<template>
    <v-container align-start justify-start fluid grid-list-xl style="background-color:#f9f9f9;">
    <h5 style="font-weight: bold; color: #0e6251; padding: 12px; text-align: center;">Popular Technology</h5>
                <v-layout justify-start row wrap child-flex>
...
.hello{
    margin-left: auto;
    margin-right: auto;
    height: 100px; width: 250px; padding: 4px; border-radius: 5px;
}
